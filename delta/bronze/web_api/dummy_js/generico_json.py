...
# MAGIC %md
# MAGIC # Generico json
# MAGIC * O objetivo dessa camada é aplicar performance quando carregamos os dados da landing para a bronze, aqui utilizamos arquivos otimizados como delta.
...
dir_arquivo_completo = f"{dir_arquivo}/{nome_arquivo}.json"

# monta os diretórios de origem e destino
dir_origem = f"/mnt/landing/{dir_arquivo_completo}"
